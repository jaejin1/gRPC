...
var fileDescriptor_d092a8920edeec73 = []byte{
	...
	0x5c, 0xa3, 0x69, 0x8c, 0x5c, 0x4c, 0x1e, 0x99, 0x42, 0xba, 0x5c, 0xac, 0xc1, 0x89, 0x95, 0x1e,
	0x99, 0x42, 0x82, 0x7a, 0x10, 0xe3, 0xf5, 0xe0, 0x66, 0x4b, 0xf1, 0x23, 0x0b, 0x15, 0xe4, 0x54,
	0x2a, 0x31, 0x08, 0xe9, 0x73, 0xb1, 0x3b, 0xe7, 0x97, 0xe6, 0x95, 0x10, 0xad, 0xc1, 0x80, 0x8b,
	0xc3, 0x2b, 0x31, 0x35, 0x2b, 0x33, 0x8f, 0x58, 0x1d, 0x49, 0x6c, 0x60, 0xdf, 0x1a, 0x03, 0x02,
	0x00, 0x00, 0xff, 0xff, 0x10, 0xf7, 0xc0, 0x14, 0xf9, 0x00, 0x00, 0x00,
}
...
type HiClient interface {
	...
	JaejinHi(ctx context.Context, in *HiRequest, opts ...grpc.CallOption) (*HiReply, error)
}
...
func (c *hiClient) JaejinHi(ctx context.Context, in *HiRequest, opts ...grpc.CallOption) (*HiReply, error) {
	out := new(HiReply)
	err := c.cc.Invoke(ctx, "/higrpc.Hi/JaejinHi", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HiServer interface {
	...
	JaejinHi(context.Context, *HiRequest) (*HiReply, error)
}
...
func (*UnimplementedHiServer) JaejinHi(ctx context.Context, req *HiRequest) (*HiReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method JaejinHi not implemented")
}
...
func _Hi_JaejinHi_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HiRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HiServer).JaejinHi(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/higrpc.Hi/JaejinHi",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HiServer).JaejinHi(ctx, req.(*HiRequest))
	}
	return interceptor(ctx, in, info, handler)
}
